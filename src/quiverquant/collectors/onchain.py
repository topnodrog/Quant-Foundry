...
requires a free-signup key (ETHERSCAN_API_KEY) — confirmed live 2026-07-02
(chainid=1 ethsupply call returned 200 with real data). fetch() skips it
silently when the key is absent rather than failing the whole collector run.
"""
